" Name: dalacritty (based on Ramzi Akremi's one vim colorscheme)
...
let g:colors_name = 'dalacritty'

if !exists('g:dalacritty_allow_italics')
  let g:dalacritty_allow_italics = 0
endif

let s:italic = ''
if g:dalacritty_allow_italics == 1
  let s:italic = 'italic'
endif
...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  fun <SID>XAPI(group, fg, bg, attr)
    let l:attr = a:attr
    if g:dalacritty_allow_italics == 0 && l:attr ==? 'italic'
      let l:attr= 'none'
    endif
  ...
  " Color definition --------------------------------------------------------{{{
    if &background ==# 'dark'
      ...
      let s:mono_4 = ['#5c5c5c', '59']    " Less important background

      let s:hue_1  = ['#8cd0d3', '87']   " cyan
      let s:hue_2  = ['#9ab8d7', '75']   " blue
      let s:hue_3  = ['#dc8cc3', '176']  " purple
      let s:hue_4  = ['#60b48a', '114']  " green

      let s:hue_5   = ['#D67979', '167'] " red 1
      let s:hue_5_2 = ['#DCA3A3', '130'] " red 2

      let s:hue_6   = ['#e5c07b', '180'] " orange 2
      let s:hue_6_2 = ['#d19a66', '173'] " orange 1

      let s:syntax_bg     = ['#2a2a2a', '16']  " Background color
      let s:syntax_gutter = ['#636d83', '60']  " Line numbers
      let s:syntax_cursor = ['#2c323c', '16']  " Cursor line

      let s:syntax_accent = ['#528bff', '69']  " Accent color

      let s:vertsplit    = ['#181a1f', '233']  " Vert split color
      let s:special_grey = ['#3b4048', '16']   " Special grey
      let s:visual_grey  = ['#3e4452', '17']   " Visual mode color
      let s:pmenu        = ['#333841', '16']   " Popup menu
    else
      let s:mono_1 = ['#2a2a2a', '16']    " Foreground color
      let s:mono_2 = ['#d7d8da', '253']   " Dimmed foreground
      let s:mono_3 = ['#d1d1d1', '188']   " Comments or less important text
      let s:mono_4 = ['#b3b3b3', '145']   " Less important background
      ...
      let s:hue_6   = ['#c18401', '136']     " orange 2
      let s:hue_6_2 = ['#986801', '94']      " orange 1

      let s:syntax_bg     = ['#dcdcdc', '16']  " Background color
      let s:syntax_gutter = ['#636d83', '60']  " Line numbers
      let s:syntax_cursor = ['#2c323c', '16']  " Cursor line
  ...
  call <sid>X('VertSplit',    s:syntax_cursor, s:syntax_cursor,  'bold')
...
" Public API --------------------------------------------------------------{{{
function! dalacritty#highlight(group, fg, bg, attr)
